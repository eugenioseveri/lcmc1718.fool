...
public class AndNode implements Node {
	...
	public String codeGeneration() {
		...
		/* Quando ho AND tra due elementi -> e1 && e2 allora: salto all'errore (push 0) se almeno una delle due espressioni valuta falso (0):
		   controllo e1, pusho 0 sullo stack, tramite 'beq' verifico l'ugualianza e salto se sono uguali;
		   se non sono uguali controllo e2, pusho 0 sullo stack, tramite 'beq' verifico l'ugualianza e salto se sono uguali;

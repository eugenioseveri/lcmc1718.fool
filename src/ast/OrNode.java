...
public class OrNode implements Node {
	...
	public String codeGeneration() {
		...
		/* Quando ho OR tra due elementi: * e1 || e2 allora: salto se almeno una delle due espressioni valuta 1:
		   controllo e1, pusho 1 sullo stack e salto se sono uguali;
		   se non sono uguali controllo e2, pusho 1 sullo stack e salto se sono uguali;

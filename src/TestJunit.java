...
public class TestJunit {
	...
	public void testFoolBaseOperators() {
		// Test della prima estensione del progetto (operatori ">=", ">=", "||", "&&", "/", "-", "!"). (baseoperators.fool) Output atteso: "0".
		try {
	...
	static class LoggedPrintStream extends PrintStream {
		...
		LoggedPrintStream(final StringBuilder sb, final OutputStream os, final PrintStream ul) {
			super(os);
			this.buffer = sb;
			this.underlying = ul;
		}

...
public class FOOLLib {
	 ...
	 */
	public enum MethodInheritanceType {
		NEW,
		INHERIT,
		OVERRIDE
	}
	 ...
	 */
	public static boolean isSubtype(final Node a, final Node b) {
	...
	public static Node lowestCommonAncestor(final Node a, final Node b) {
	 ...
	 * @param code codice
	 */
	public static void putCode(final String code) {
